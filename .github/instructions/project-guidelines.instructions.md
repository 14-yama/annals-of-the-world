...
ui/src/
  ...
  constants/           # App-wide constants
    ...
    frameworks.ts      # 10 interpretive frameworks
```
...
**Current count: 10,580 unique actors across 7 eras.**

| Metric | Value |
| ------ | ----- |
| Total unique actors | 10,580 |
...
| Frameworks | 8 interpretive frameworks auto-assigned |
...
| Hand-Curated Era Catalogs | 336 | `catalog/prehistoric.ts` through `catalog/contemporary.ts` |
| Division Enrichment | 119 | `catalog/divisionEnrichment.ts` |
| Biblical + Reformation | 120 | `catalog/biblical.ts`, `catalog/reformation.ts` |
| Corpus Catalog (13 collections) | 176 | `catalog/corpuses/*.ts` |

After slug-based deduplication (hand-curated wins over auto-generated), the catalog
contains **10,580 unique actors**.
...
- **Annals Catalog (source of truth):** `ui/src/data/catalog/index.ts` — 10,580 unique actors
