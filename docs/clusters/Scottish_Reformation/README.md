...
| ----- | ---- | --- | ----------- |
| Cardinal_David_Beaton | CENSORS | Evangelical_Currents_in_Scotland | Cardinal David Beaton censors Evangelical Currents in Scotland. (auto-generated from README wiring). |
| Scottish_Regency_Council | ORGANIZES | Congregation_Risings_1559 | Scottish Regency Council organizes Congregation Risings 1559. (auto-generated from README wiring). |
| Knox_Writings_1558_The_First_Blast | FRAMES | Presbyterianism | Knox Writings 1558 The First Blast frames Presbyterianism. (auto-generated from README wiring). |
| John_Knox | ENDORSES | Presbyterianism | John Knox endorses Presbyterianism. (auto-generated from README wiring). |
| Wishart_Execution_1546 | OCCURS_IN | St_Andrews | Wishart Execution 1546 occurs in St Andrews. (auto-generated from README wiring). |
| Congregation_Risings_1559 | OCCURS_IN | Perth | Congregation Risings 1559 occurs in Perth. (auto-generated from README wiring). |
| Scottish_Parliament | PROMULGATES | Scots_Confession_1560 | Scottish Parliament promulgates Scots Confession 1560. (auto-generated from README wiring). |
| General_Assembly_of_the_Kirk | PROMULGATES | First_Book_of_Discipline_1560 | General Assembly of the Kirk promulgates First Book of Discipline 1560. (auto-generated from README wiring). |
| Lords_of_the_Congregation | ORGANIZES | Reformation_Parliament_1560 | Lords of the Congregation organizes Reformation Parliament 1560. (auto-generated from README wiring). |
| Scots_Confession_1560 | STANDARDIZES | Presbyterianism | Scots Confession 1560 standardizes Presbyterianism. (auto-generated from README wiring). |
| Book_of_Common_Order | TRANSMITS | Presbyterianism | Book of Common Order transmits Presbyterianism. (auto-generated from README wiring). |
| Reformation_Parliament_1560 | OCCURS_IN | Edinburgh | Reformation Parliament 1560 occurs in Edinburgh. (auto-generated from README wiring). |
| Second_Book_of_Discipline_1578 | STANDARDIZES | Presbyterianism | Second Book of Discipline 1578 standardizes Presbyterianism. (auto-generated from README wiring). |
| Black_Acts_1584 | CENSORS | Presbyterianism | Black Acts 1584 censors Presbyterianism. (auto-generated from README wiring). |
| Golden_Act_1592 | STANDARDIZES | Presbyterianism | Golden Act 1592 standardizes Presbyterianism. (auto-generated from README wiring). |
| Andrew_Melville | ENDORSES | Presbyterianism | Andrew Melville endorses Presbyterianism. (auto-generated from README wiring). |
| James_VI | ENDORSES | Episcopacy_in_Scotland | James VI endorses Episcopacy in Scotland. (auto-generated from README wiring). |
| Ruthven_Raid_1582 | OCCURS_IN | Edinburgh | Ruthven Raid 1582 occurs in Edinburgh. (auto-generated from README wiring). |
