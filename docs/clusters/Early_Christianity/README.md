...
| ----- | ---- | --- | ----------- | ------------ | ------------------------- | --------- | ----------- |
| ----- | ---- | --- | ----------- |  | Chicago 17 |  |  |
| Early_Christianity | IS_PART_OF | Christian_Tradition | Early Christianity has parent root Christian Tradition. |  | Chicago 17 |  |  |
| Early_Christianity | INTERFACES_WITH | Hebrew_Tradition | Early Christianity interfaces with Hebrew Tradition. |  | Chicago 17 |  |  |
| Early_Christianity | INTERFACES_WITH | Roman_Empire | Early Christianity interfaces with Roman Empire. |  | Chicago 17 |  |  |
| Early_Christianity | INTERFACES_WITH | Hellenistic_Philosophy | Early Christianity interfaces with Hellenistic Philosophy. |  | Chicago 17 |  |  |
| Early_Christianity | INTERFACES_WITH | Late_Antique_Christianity | Early Christianity interfaces with Late Antique Christianity. |  | Chicago 17 |  |  |
...
| Apostolic_Leadership | DECLARES | Persecution_in_Jerusalem_(c._35_CE |
...
| Quadratus_of_Athens | PUBLISHES | Apologists_(Justin,_Tertullian,_Origen |
