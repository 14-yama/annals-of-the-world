...
:--|:--|:--|:--|:--|:--|:--|:--|:--|:--
P | COLLABORATES_WITH; DEBATES; INFLUENCES | ESTABLISHES; INFLUENCES; DECLARES | AUTHORS; TRANSLATES; PUBLISHES; EDITS; COMMENTATES_ON; INTERPRETS | ADOPTS; REJECTS; INTERPRETS; DECLARES; DEFINES | ADOPTS; REJECTS; PROMOTES; INFLUENCES | DECLARES; PROPHESIES_DURING; SURVIVES | DIFFUSES | FRAMES | —
I | DECLARES; INFLUENCES | SCHISMS_FROM; RECONCILES_WITH; INFLUENCES | CANONIZES; STANDARDIZES; PRESERVES; PUBLISHES; EDITS; DISTRIBUTES | CANONIZES; STANDARDIZES; REJECTS; DECLARES; DEFINES | PROMOTES; REJECTS; INFLUENCES | ORGANIZES; DECLARES | DIFFUSES | FRAMES | —
...
| P | T | AUTHORS; TRANSLATES; PUBLISHES; EDITS; COMMENTATES_ON; INTERPRETS | Rashi COMMENTATES_ON Talmud |
...
- → T
  - Canonical: AUTHORS, TRANSLATES, PUBLISHES, EDITS, COMMENTATES_ON, INTERPRETS
...
- → D
  - Canonical: CANONIZES, STANDARDIZES, REJECTS, DECLARES, DEFINES
- → M
...
- P → T: AUTHORS, TRANSLATES, PUBLISHES, EDITS, COMMENTATES_ON, INTERPRETS, SYSTEMATIZES
- P → D: ADOPTS, REJECTS, INTERPRETS, SYSTEMATIZES, DECLARES, DEFINES, INFLUENCES
...
- I → D: CANONIZES, STANDARDIZES, REJECTS, DECLARES, DEFINES
