...
| From \ To | P (Person) | I (Institution) | T (Text/Artifact) | D (Doctrine/Idea) | M (Movement) | E (Event/Process) | L (Place/Location) | F (Framework) | V (Evidence) | C (Corpus) |
|:--|:--|:--|:--|:--|:--|:--|:--|:--|:--|:--|
| **P** | COLLABORATES_WITH; DEBATES; INFLUENCES | ESTABLISHES; INFLUENCES; DECLARES | TRANSLATES; PUBLISHES; EDITS; COMMENTATES_ON; INTERPRETS; SYSTEMATIZES | ADOPTS; REJECTS; INTERPRETS; SYSTEMATIZES; DECLARES | ADOPTS; REJECTS; PROMOTES; INFLUENCES | DECLARES; PROPHESIES_DURING; SURVIVES | DIFFUSES | FRAMES | — | — |
| **I** | DECLARES; INFLUENCES; AWARDS; TRAINS; ENROLLS; COMMANDS | SCHISMS_FROM; RECONCILES_WITH; INFLUENCES; PARTNERS_WITH; ALLIES_WITH | CANONIZES; STANDARDIZES; PRESERVES; PUBLISHES; EDITS; DISTRIBUTES; CURATES; EXHIBITS; BROADCASTS | CANONIZES; STANDARDIZES; REJECTS; DECLARES; LEGISLATES | PROMOTES; REJECTS; INFLUENCES | ORGANIZES; DECLARES; ADJUDICATES | DIFFUSES; GOVERNS; ADMINISTERS; CONTROLS; OCCUPIES; PATROLS | FRAMES | — | — |
| **T** | INFLUENCES | INFLUENCES | TRANSMITS; TRANSLATES | INTERPRETS; TRANSMITS; EXEMPLIFIES | INFLUENCES; TRANSMITS | ENABLES; CAUSES | DIFFUSES | FRAMES | — | — |
| **D** | INFLUENCES | INFLUENCES | INFLUENCES | INFLUENCES | INFLUENCES | CAUSES; FRAMES | DIFFUSES | FRAMES | — | — |
| **M** | INFLUENCES | SCHISMS_FROM; RECONCILES_WITH; INFLUENCES | INFLUENCES; TRANSMITS; ADOPTS; REJECTS | INFLUENCES; TRANSMITS; ADOPTS; REJECTS | SCHISMS_FROM; RECONCILES_WITH; INFLUENCES | CAUSES; ORGANIZES | DIFFUSES | FRAMES | — | — |
| **E** | — | — | — | TRANSFORMS; CAUSES; ENABLES | TRANSFORMS; CAUSES; ENABLES | CAUSES; PRECEDES; IS_PART_OF | OCCURS_IN | FRAMES | — | — |
| **L** | — | — | — | SACRED_TO | — | — | CONTAINS; BORDERS; CAPITAL_OF | — | — | — |
| **F** | — | — | — | — | — | — | — | (target-only) | — | — |
| **V** | DOCUMENTS | DOCUMENTS | DOCUMENTS | ATTESTS_TO | DOCUMENTS | DATES; DOCUMENTS | — | — | — | BELONGS_TO; DOCUMENTS |
| **C** | — | — | CONTAINS; INCLUDES; ORGANIZES; CANONIZES | DEFINES; EXEMPLIFIES; INFLUENCES | INFLUENCES | — | — | FRAMES | DOCUMENTS; BELONGS_TO | SUBSUMES; SPLITS_INTO; IS_PART_OF |

## P (Person) → …

| From | To | Canonical verbs | Example |
|:--|:--|:--|:--|
| P | P | COLLABORATES_WITH; DEBATES; INFLUENCES | Heschel COLLABORATES_WITH King |
| P | I | ESTABLISHES; INFLUENCES; DECLARES | Leader ESTABLISHES Council |
| P | T | TRANSLATES; PUBLISHES; EDITS; COMMENTATES_ON; INTERPRETS; SYSTEMATIZES | Rashi COMMENTATES_ON Talmud |
| P | D | ADOPTS; REJECTS; INTERPRETS; SYSTEMATIZES; DECLARES | Maimonides SYSTEMATIZES Jewish_Philosophy |
| P | M | ADOPTS; REJECTS; PROMOTES; INFLUENCES | Thinker PROMOTES Haskalah |
| P | E | DECLARES; PROPHESIES_DURING; SURVIVES | Jeremiah PROPHESIES_DURING Babylonian_Exile |
...
| From | To | Canonical verbs | Example |
|:--|:--|:--|:--|
| I | I | SCHISMS_FROM; RECONCILES_WITH; INFLUENCES; PARTNERS_WITH; COMPETES_WITH; ALLIES_WITH | Synod SCHISMS_FROM Patriarchate |
| I | P | DECLARES; INFLUENCES; AWARDS; TRAINS; ENROLLS; ADJUDICATES; COMMANDS | Council DECLARES Office |
| I | T | CANONIZES; STANDARDIZES; PRESERVES; PUBLISHES; EDITS; DISTRIBUTES; CURATES; EXHIBITS; BROADCASTS | Church CANONIZES Text |
| I | D | CANONIZES; STANDARDIZES; REJECTS; DECLARES; LEGISLATES | Academy STANDARDIZES Curriculum |
| I | M | PROMOTES; REJECTS; INFLUENCES | Institution PROMOTES Movement |
| I | E | ORGANIZES; DECLARES; ADJUDICATES | Committee ORGANIZES Congress |
| I | L | DIFFUSES; GOVERNS; ADMINISTERS; CONTROLS; OCCUPIES; PATROLS | Empire GOVERNS Province |
| I | F | FRAMES | Institution FRAMES DOCTRINE_DEVELOPMENT |
- ↔ I
  - Canonical: SCHISMS_FROM, RECONCILES_WITH, INFLUENCES, PARTNERS_WITH, COMPETES_WITH, ALLIES_WITH
- → P
  - Canonical: DECLARES, INFLUENCES, AWARDS, TRAINS, ENROLLS, ADJUDICATES, COMMANDS
- → T
  - Canonical: CANONIZES, STANDARDIZES, PRESERVES, PUBLISHES, EDITS, DISTRIBUTES, CURATES, EXHIBITS, BROADCASTS
- → D
  - Canonical: CANONIZES, STANDARDIZES, REJECTS, DECLARES, LEGISLATES
- → M
  - Canonical: PROMOTES, REJECTS, INFLUENCES
- → E
  - Canonical: ORGANIZES, DECLARES, ADJUDICATES
- → L
  - Canonical: DIFFUSES, GOVERNS, ADMINISTERS, CONTROLS, OCCUPIES, PATROLS
- → F
  - Canonical: FRAMES
- → V
  - Typically N/A
...
| From | To | Canonical verbs | Example |
|:--|:--|:--|:--|
| L | L | CONTAINS; BORDERS | Continent CONTAINS Country; France BORDERS Germany |
| L | I | CONTAINS | City CONTAINS University |
| L | D/M | SACRED_TO | Jerusalem SACRED_TO Abrahamic_Theology |
| L | L/I | CAPITAL_OF | Paris CAPITAL_OF France |
- → L
  - Canonical: CONTAINS (parent→child geo hierarchy), BORDERS (adjacency)
  - Example: (Africa) CONTAINS (Nigeria); (France) BORDERS (Germany)
- → I
  - Canonical: CONTAINS (Place hosts Institution)
  - Example: (Oxford) CONTAINS (University_of_Oxford)
- → D/M
  - Canonical: SACRED_TO (for holy sites/pilgrimage)
  - Example: (Jerusalem) SACRED_TO (Abrahamic_Theology)
- Receives: OCCURS_IN (from E), DIFFUSES (from P/I/M/T/D), GOVERNS/ADMINISTERS/CONTROLS/OCCUPIES (from I/P), SITUATED_IN (from I/E)
...
| From | To | Canonical verbs | Example |
|:--|:--|:--|:--|
| C | T | CONTAINS; INCLUDES; ORGANIZES; CANONIZES | BIBLICAL_CORPUS CONTAINS Hebrew_Bible |
| C | D | DEFINES; EXEMPLIFIES; INFLUENCES | BIBLICAL_CORPUS EXEMPLIFIES Monotheism |
| C | M | INFLUENCES | BIBLICAL_CORPUS INFLUENCES Reformation |
| C | F | FRAMES | BIBLICAL_CORPUS FRAMES HISTORICAL_CHRONOLOGY |
| C | V | DOCUMENTS; BELONGS_TO | BIBLICAL_CORPUS DOCUMENTS Dead_Sea_Scrolls |
| C | C | SUBSUMES; SPLITS_INTO; IS_PART_OF | BIBLICAL_CORPUS SUBSUMES JUDAIC_RABBINIC_CORPUS |

- → T
  - Canonical: CONTAINS, INCLUDES, ORGANIZES, CANONIZES
  - Example: (BIBLICAL_CORPUS) CONTAINS (Hebrew_Bible)
- → D
  - Canonical: DEFINES, EXEMPLIFIES, INFLUENCES
  - Example: (BIBLICAL_CORPUS) EXEMPLIFIES (Monotheism)
- → M
  - Canonical: INFLUENCES
  - Example: (BIBLICAL_CORPUS) INFLUENCES (Reformation)
- → F
  - Canonical: FRAMES
  - Example: (BIBLICAL_CORPUS) FRAMES (HISTORICAL_CHRONOLOGY)
- → V
  - Canonical: DOCUMENTS, BELONGS_TO
  - Example: (BIBLICAL_CORPUS) DOCUMENTS (Dead_Sea_Scrolls)
- → C
  - Canonical: SUBSUMES, SPLITS_INTO, IS_PART_OF
  - Example: (BIBLICAL_CORPUS) SUBSUMES (JUDAIC_RABBINIC_CORPUS)
