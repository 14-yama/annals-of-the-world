---
title: Hebrew Bible cluster — Timeframes (class 9)
status: PROPOSED
class: 9
summary: |
  Cluster scaffold for Hebrew Bible concepts, people, events, texts and evidence
  organized by Timeframes class (9) and division ids (910–960). All nodes are
  provisionally STATUS: PROPOSED. Relationships should use active-voice verbs
  (e.g., EXPLAINS, INFLUENCES, OCCURRED_IN, FRAMES) and include FRAMED_BY edges
  with per-edge citations when events are assigned to EventWindows.
---

# Hebrew Bible cluster (Timeframes class 9) — PROPOSED

This file contains a cleaned, project-style scaffold for the Hebrew Bible
cluster aligned to the project's Timeframes class (9) and divisions 910–960.
Every listed node is status: PROPOSED. Relationships must later be written in
active-voice verbs and include per-edge citations.

Group by 9 – Timeframes
- 910 Prehistoric
- 920 Classical
- 930 Medieval
- 940 Early Modern
...
Each division below lists Ideas, People, Events, Institutions, Places,
Movements, Texts/Artifacts, and Evidence where appropriate.

## 910 — Prehistoric (mythic–early 2nd millennium BCE)
status: PROPOSED

Ideas
- Primeval history themes (Creation, Fall, Flood, Babel)
- Chosenness / Election
...
- Elephantine (Jewish colony in Egypt)
...
- Hillel & Shammai (Pharisaic teachers)
- Judah haNasi (Mishnah redactor)
- Amoraim (Palestinian & Babylonian)
- Saadia Gaon
- Rashi
- Maimonides
- Nachmanides (Ramban)
...
Institutions
- Yavneh academy
- Babylonian academies (Sura, Pumbedita)
- Synagogue (communal center)
- Gaonic leadership
...
1. Assign EventWindows → Eras/Periods and attach `FRAMED_BY` historian lenses with per-edge citations.
2. Expand each Period/Era/Epoch with additional proposed people, events, texts and evidence to ensure even chronological coverage.
3. Convert this scaffold into importable CSV/seed files or generate `EventWindow` nodes via the project's MCP/migration workflow.
