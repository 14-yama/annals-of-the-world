...
const CLASSIFICATION_ENTRIES = [
  ...
  { classNum: '3', name: 'Institutions', heading: 'Organizations, councils, governing bodies', color: '#8B3A3A', divisions: ['310 Political Institutions', '320 Legal Institutions', '330 Economic Institutions', '340 Religious Orders', '350 Scientific Bodies', '360 Cultural Institutions', '370 International Organizations', '380 Educational Institutions'] },
  ...
  { classNum: '5', name: 'Events', heading: 'Historical occurrences & event windows', color: '#C53030', divisions: ['510 Wars & Conflicts', '520 Revolutions', '530 Elections & Governance', '540 Scientific Discoveries', '550 Environmental Crises', '560 Trials & Legal', '570 Religious Events', '580 Cultural Events', '590 Agricultural & Economic Events'] },
  { classNum: '6', name: 'Movements', heading: 'Social, political, religious movements', color: '#6B3FA0', divisions: ['610 Political Movements', '620 Social Movements', '630 Religious Movements', '640 Cultural Movements', '650 Scientific Movements', '660 Environmental Movements', '680 Trade & Navigation Movements'] },
  { classNum: '7', name: 'Texts & Artifacts', heading: 'Written works, codices, constitutions', color: '#5A2222', divisions: ['710 Constitutions & Codes', '720 Scriptures', '730 Scientific Works', '740 Artworks', '750 Technologies', '780 Historical & Literary Texts'] },
