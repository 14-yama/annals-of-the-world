/* ─── ISO 3166-1 Numeric → Alpha-3 Code Mapping ─── */
/* world-atlas@2 uses numeric IDs; our data files use ISO_A3 */
export const ISO_NUMERIC_TO_A3: Record<string, string> = {
  ...
  '156': 'CHN', '158': 'TWN', '170': 'COL', '174': 'COM', '175': 'MYT',
  ...
  '458': 'MYS', '462': 'MDV', '466': 'MLI', '470': 'MLT', '474': 'MTQ',
  ...
  '646': 'RWA', '652': 'BLM', '659': 'KNA', '660': 'AIA', '662': 'LCA',
  '663': 'MAF', '666': 'SPM', '670': 'VCT', '674': 'SMR', '678': 'STP',
  ...
  '887': 'YEM', '894': 'ZMB',
  // Kosovo (not in ISO standard but in Natural Earth data)
  '-99': 'XKX', '900': 'XKX',
  // Some datasets use these alternate IDs
  '736': 'SDN',
}
