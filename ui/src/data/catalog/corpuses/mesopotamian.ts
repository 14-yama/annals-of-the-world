...
export const MESOPOTAMIAN_ENTITIES: Entity[] = [
  ...
  },
  {
    ...
    name: 'Hammurabi',
    label: 'Person',
    callNumber: '250.11-hammurabi',
    subjectHeadings: ['People — Ancient Rulers — Babylonian Kings'],
    subjects: ['Babylon', 'Law Code', 'Amorite Dynasty', 'Justice', 'Empire Builder', 'First Babylonian Dynasty'],
    summary: 'Sixth king of the First Babylonian Dynasty (r. 1792–1750 BCE) who unified most of Mesopotamia under Babylonian control and promulgated the famous Code of Hammurabi — one of the oldest and most complete surviving written legal codes. Through military prowess and diplomatic cunning, he transformed Babylon from a minor city-state into the capital of an empire. His law code, inscribed on a basalt stele, established graduated justice across social classes and became a template for subsequent ancient Near Eastern legal traditions.',
    born: 'c. 1810 BCE',
    died: '1750 BCE',
    era: 'Classical',
    eraSlug: 'classical',
    ...
    causes: [],
    effects: [
      { title: 'Code of Hammurabi establishes written statutory law', type: 'Text', year: '1754 BCE', slug: 'code_of_hammurabi' },
    ],
    relationships: [
      { sourceSlug: 'hammurabi', sourceName: 'Hammurabi', verb: 'AUTHORS', targetSlug: 'code_of_hammurabi', targetName: 'Code of Hammurabi', context: 'Royal decree establishing 282 laws' },
    ],
    places: [
  ...
  },
  {
    ...
    name: 'Babylon',
    label: 'Place',
    callNumber: '440.13-babylon-city',
    subjectHeadings: ['Places — Ancient Cities — Mesopotamian Cities'],
    subjects: ['Babylonia', 'Hammurabi', 'Nebuchadnezzar', 'Ishtar Gate', 'Hanging Gardens', 'Euphrates'],
    summary: 'Capital of the Babylonian Empire, situated on the Euphrates River in modern Iraq. First rising to prominence under Hammurabi (c. 1792–1750 BCE), Babylon reached its greatest extent under the Neo-Babylonian Empire (626–539 BCE) of Nebuchadnezzar II. The city featured the Ishtar Gate (brilliant blue-glazed brick), the Processional Way, the Esagila temple complex of Marduk, and the legendary Hanging Gardens. As both political capital and cultural center, Babylon was the nexus for Mesopotamian astronomy, mathematics, legal codification, and religious ritual, remaining a symbol of imperial grandeur and, in biblical literature, of human hubris.',
    era: 'Classical',
    eraSlug: 'classical',
    region: 'Middle East',
    continent: 'Asia',
